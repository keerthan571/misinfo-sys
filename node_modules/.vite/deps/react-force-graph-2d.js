...
function L(n2, l2, u2, t5, i2, r2, o2, e3, f2, c5, a3) {
  ...
  for (f2 = T(u2, l2, m3, f2, b10), s2 = 0; s2 < b10; s2++)
    null != (p2 = u2.__k[s2]) && (h2 = -1 != p2.__i && m3[p2.__i] || d, p2.__i = s2, _2 = q(n2, p2, h2, i2, r2, o2, e3, f2, c5, a3), v2 = p2.__e, p2.ref && h2.ref != p2.ref && (h2.ref && J(h2.ref, null, p2), a3.push(p2.ref, p2.__c || v2, p2)), null == y3 && null != v2 && (y3 = v2), (g2 = !!(4 & p2.__u)) || h2.__k === p2.__k ? (f2 = j(p2, f2, n2, g2), g2 && h2.__e && (h2.__e = null)) : "function" == typeof p2.type && void 0 !== _2 ? f2 = _2 : v2 && (f2 = v2.nextSibling), p2.__u &= -7);
  return u2.__e = y3, f2;
}
...
function O(n2, l2, u2, t5) {
  ...
  if (null === c5 && null == e3 || a3 && e3 == c5.key && f2 == c5.type)
    return u2;
  if (t5 > (a3 ? 1 : 0)) {
...
function N(n2, l2, u2, t5, i2) {
  ...
  n:
    if ("style" == l2)
      ...
      r2 = l2 != (l2 = l2.replace(s, "$1")), o2 = l2.toLowerCase(), l2 = o2 in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? o2.slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? t5 ? u2[a] = t5[a] : (u2[a] = h, n2.addEventListener(l2, r2 ? v : p, r2)) : n2.removeEventListener(l2, r2 ? v : p, r2);
    else {
...
function q(n2, u2, t5, i2, r2, o2, e3, f2, c5, a3) {
  ...
  n:
    if ("function" == typeof T2)
      ...
      null == o2 && u2.__v == t5.__v ? (u2.__k = t5.__k, u2.__e = t5.__e) : f2 = u2.__e = G(t5.__e, u2, t5, i2, r2, o2, e3, c5, a3);
...
function G(u2, t5, i2, r2, o2, e3, f2, c5, a3) {
  ...
  if ("svg" == x3 ? o2 = "http://www.w3.org/2000/svg" : "math" == x3 ? o2 = "http://www.w3.org/1998/Math/MathML" : o2 || (o2 = "http://www.w3.org/1999/xhtml"), null != e3) {
    for (s2 = 0; s2 < e3.length; s2++)
      if ((y3 = e3[s2]) && "setAttribute" in y3 == !!x3 && (x3 ? y3.localName == x3 : 3 == y3.nodeType)) {
        u2 = y3, e3[s2] = null;
        break;
      }
  }
  ...
  if (null == x3)
    ...
    if (e3 = "textarea" == x3 && null != k2.defaultValue ? null : e3 && n.call(u2.childNodes), !c5 && null != e3)
    ...
    else if (p2 && (u2.innerHTML = ""), L("template" == t5.type ? u2.content : u2, g(v2) ? v2 : [v2], t5, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e3, f2, e3 ? e3[0] : i2.__k && $(i2, 0), c5, a3), null != e3)
      for (s2 = e3.length; s2--; )
        b(e3[s2]);
