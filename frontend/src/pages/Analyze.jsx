      ...
      {result?.analysis && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-800 rounded-2xl shadow-lg p-6 text-white">
            ...
            <p>
              ❤️ Likes:{" "}
              {result.analysis.engagement?.likes ?? "Not detected"}
            </p>

            <p>
              🔁 Shares/Reposts:{" "}
              {result.analysis.engagement?.shares ?? "Not detected"}
            </p>

            <p>
              👀 Views:{" "}
              {result.analysis.engagement?.views ?? "Not detected"}
            </p>

            <p>
              🔖 Bookmarks:{" "}
              {result.analysis.engagement?.bookmarks ?? "Not detected"}
            </p>
          </div>
