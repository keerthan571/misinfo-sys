    ...
    <div className="bg-slate-800 rounded-2xl p-6 shadow-lg">
      ...
      <div className="mt-6">
        ...
        <select
          ...
          className="w-full mt-3 bg-slate-900 text-white rounded-xl p-3 border border-slate-600"
        >
      ...
      <button
        ...
        className="mt-8 w-full bg-blue-600 hover:bg-blue-700 disabled:bg-slate-600 py-3 rounded-xl font-bold text-white"
      >
